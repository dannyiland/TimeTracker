...
public class ProximityDetector extends Detector {

	  private SQLiteDatabase db;

	    public ProximityDetector(String... params) {
	        //ProximityDetector doesn't actually use any params.
	        super(params);
	    }
	    ...
	    public List<Event> getEvents(long startTime, long endTime) {
	        ...
	        Cursor c = db.query(EventDb.TABLE_NAME, null, EventDb.SELECT_TIME_TYPE,
	                EventDb.getTimeTypeArgs(startTime, endTime, "proximity-NEAR"),
	                null, null, null);
	        ...
	        if (c.getCount() > 0) {
	            ...
	            while (!c.isAfterLast()) {
	                ...
	                events.add(new Event("ProximityDetector", "Proximity detected at " + timeStamp, 1, this));
	                c.moveToNext();
	            }
	        }
