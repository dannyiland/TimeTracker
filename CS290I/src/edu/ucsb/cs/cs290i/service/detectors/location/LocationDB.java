...
public class LocationDB extends SQLiteOpenHelper {
	...
	public static final String LOCATION_TABLE_NAME="Locations Visited";
	public static final String KNOWN_LOCATION_TABLE_NAME="Known Locations";
    ...
    private static final String CREATE_KNOWN_LOCATION_TABLE =
            "CREATE TABLE " + KNOWN_LOCATION_TABLE_NAME + " (" +
    ...
    public static final String SELECT_TIME_TYPE = KEY_TIMESTAMP + " > ? AND " + KEY_TIMESTAMP + " < ? AND "
            + KEY_LOCATION_TYPE + " = ?";
	public static final String ALL_KNOWN_LOCATIONS = "*";
	...
	public static ArrayList<LocationInstance> getAllKnownLocations(Context context) {
		...
		Cursor c = db.query(LocationDB.LOCATION_TABLE_NAME, null, LocationDB.ALL_KNOWN_LOCATIONS,null,null, null, null);
		if (c.getCount() > 0) {
			c.moveToFirst();
			while (!c.isAfterLast()) {
