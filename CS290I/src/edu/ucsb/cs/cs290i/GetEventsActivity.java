		...
		public void handleEvent(ALEvents event, Object data) {
			if (event == ALEvents.USERSTATS_OF_A_PLACE_CALLBACK) {
				...
				for (UserStay stay: stays) {
					LocationInstance newLoc = new LocationInstance(stay.getCandidates(), stay.getCentroidLatE6(), stay.getCentroidLngE6(), stay.getStartTime(), stay.getEndTime());
					visits.add(newLoc);
				}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getEvents.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				List<Event> events = service.getEvents(System.currentTimeMillis() - TEN_MINUTES, System.currentTimeMillis());
				for (Event e : events) {
		...
		getLocations.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				ArrayList<LocationInstance> locations = getLocations(System.currentTimeMillis() - TEN_MINUTES, System.currentTimeMillis());
